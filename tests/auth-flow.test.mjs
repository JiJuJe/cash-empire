...
test("Google callback creates a stable account, username is unique, and sign out revokes session",async()=>{
  ...
  database.exec(readFileSync(new URL("../migrations/0005_admin_moderation.sql",import.meta.url),"utf8")); database.exec(readFileSync(new URL("../migrations/0006_store_cosmetics_bills.sql",import.meta.url),"utf8"));
